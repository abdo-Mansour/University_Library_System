...
class UpdateUserDetails(ttk.Frame):
    def __init__(self, parent, app, controller):
        ...
        # show User info
        self.show_info_label = ttk.Label(self, text='Update User Details', font=("Helvetica", 18, 'bold'))
    ...
    def create_user_info_table(self):
        ...
        ttk.Button(self, text="Save Changes", command=self.save_changes).grid(row=row, column=0, columnspan=2, pady=20)
